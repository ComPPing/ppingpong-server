...
public class GoogleTokenReqDto {
    ...
    @Builder
    public GoogleTokenReqDto(String clientId, String redirectUri, String clientSecret, String responseType, String scope, String code, String accessType, String grantType, String state, String includeGrantedScopes, String loginHint, String prompt) {
